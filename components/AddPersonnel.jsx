...
const AddPersonnel = ({ changeDisplayState, handlePersonnelDataFetch }) => {
  ...
  return (
    <div className="fixed top-[10%] lg:right-[30%] lg:left-[30%] sm:right-[20%] sm:left-[20%] right-[10%] left-[10%] px-4 py-8 rounded-md shadow-md z-50 bg-white">
      ...
      <form onSubmit={handleSubmit}>
        <div className="py-2">
          <h3 className="text-center text-2xl">Add new Personnel</h3>
        </div>
        ...
        <div className="py-4 px-10">
          ...
          <div className="py-3">
            <Button type="submit">{isLoading && <Loader2 />} Add</Button>
          </div>
        </div>
      </form>
    </div>
